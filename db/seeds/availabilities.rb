...
# get first 6 users
create_availabilities(User.all.limit(6), Service.first)

# create availabilities for the next 6 users
create_availabilities(User.all.offset(6).limit(6), Service.last)

def create_availabilities(users, service)
		...
		while current_date < next_month
			...
			# iterate over the shift start_time to end_time
